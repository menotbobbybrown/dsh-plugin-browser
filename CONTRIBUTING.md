# Contributing to @modelnorth/dsh-plugin-browser

Welcome! We are excited to have you contribute to `@modelnorth/dsh-plugin-browser` (Native Headless & Visible Web Browser Automation Agent for DeepSeek Harness).
...
- [Issue Tracker](https://github.com/menotbobbybrown/dsh-plugin-browser/issues)
...
git clone https://github.com/<your-username>/dsh-plugin-browser.git
...
If you have a new feature idea, feel free to open a [Feature Request Issue](https://github.com/menotbobbybrown/dsh-plugin-browser/issues/new?template=feature_request.md) first to discuss architecture before writing code.
